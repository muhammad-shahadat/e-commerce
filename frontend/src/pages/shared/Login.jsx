...
const Login = () => {
  ...
  return (
    <main
      className={`min-h-screen flex items-center justify-center bg-gray-50 px-6 py-12 transition-all duration-300 ${!isMenuOpen ? 'md:pl-5' : ''}`}
    >
      <div className="w-full max-w-lg bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-gray-100 flex flex-col p-8 md:p-12 gap-8 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="space-y-6">
          <p className="text-center text-gray-500 font-medium text-sm md:text-base">
            ...
            <span className="text-indigo-600 font-bold hover:underline cursor-pointer transition-all">
              Login here
            </span>
          </p>
          ...
          <div className="flex items-start gap-3 bg-gray-50 p-4 rounded-2xl border border-gray-100">
            ...
            <label
              htmlFor="terms"
              className="text-xs md:text-sm text-gray-500 leading-snug cursor-pointer"
            >
