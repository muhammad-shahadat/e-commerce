      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id}>
            ...
            <div className={`flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-12 lg:px-16 py-12 md:py-16 bg-gradient-to-br ${slide.bgColor} min-h-[450px] md:min-h-[500px] transition-all duration-1000`}>
              
              {/* --- Left Content: Text and CTA Buttons --- */}
              <div className="flex-1 space-y-4 text-center md:text-left mt-8 md:mt-0">
                <p className={`text-xs md:text-sm font-bold tracking-widest uppercase ${slide.accentColor}`}>
                  {slide.offer}
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 pt-2">
                  <button className={`px-8 py-3 ${slide.btnColor} text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-md cursor-pointer text-sm md:text-base`}>
                    {slide.button1}
                  </button>
                  ...
                  <button className="group flex items-center gap-2 px-4 py-3 font-bold text-gray-700 hover:text-gray-900 transition-all cursor-pointer text-sm md:text-base">
                    {slide.button2}
                    <ArrowRight className="group-hover:translate-x-1 transition-transform text-gray-400" size={18} />
                  </button>
                </div>
              </div>
